rem *********************************************************** 
rem
rem	File: overall_memory_advice.sql 
rem	Description: Combined  (PGA+SGA) memory advice report for 10g 
rem   
rem	From 'Oracle Performance Survival Guide' by Guy Harrison
rem		Chapter 20 Page 584
...
col buffer_cache format a12 heading "Buffer Cache|Change"
