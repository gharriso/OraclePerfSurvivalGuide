/* Formatted on 2008/11/21 22:34 (Formatter Plus v4.8.7) */
SPOOL semijoin
SET serveroutput on
...
INSERT INTO google_customers
   SELECT c.cust_id,
          ...
          c.cust_marital_status, c.cust_street_address, c.cust_postal_code,
          c.cust_city, c.cust_city_id, c.cust_state_province,
          c.cust_state_province_id, c.country_id, c.cust_main_phone_number,
          c.cust_income_level, c.cust_credit_limit, c.cust_email,
          c.cust_total, c.cust_total_id, c.cust_src_id, c.cust_eff_from,
...
SELECT count(*) 
  FROM "OPSG"."MICROSOFT_CUSTOMERS" "M", "OPSG"."GOOGLE_CUSTOMERS" "G"
 WHERE "M"."CUST_FIRST_NAME" = "G"."CUST_FIRST_NAME"
   AND "M"."CUST_LAST_NAME" = "G"."CUST_LAST_NAME";
