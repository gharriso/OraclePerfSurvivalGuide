...
ALTER SESSION SET tracefile_identifier=intersect;
...
SELECT cust_first_name, cust_last_name, cust_year_of_birth
  FROM microsoft_customers JOIN google_customers
       USING (cust_first_name, cust_last_name, cust_year_of_birth); 
...
DECLARE  /* gh1 intersect  */
   CURSOR c1
   IS
      SELECT                                            
             ' gh1 intersect' t,cust_first_name  cust_first_name, cust_last_name,
             cust_year_of_birth
        FROM microsoft_customers gh1 
      INTERSECT
      SELECT '  gh1 intersect' t,cust_first_name cust_first_name, cust_last_name,
             cust_year_of_birth
        FROM google_customers;
...
/* Formatted on 2008/11/29 22:52 (Formatter Plus v4.8.7) */
DECLARE                                                         /* gh1 join */
   CURSOR c1
   IS
      SELECT ' gh1 join ', cust_first_name, cust_last_name,
             cust_year_of_birth
        FROM microsoft_customers JOIN google_customers
             USING (cust_first_name, cust_last_name, cust_year_of_birth)
             ;
